...
- Removed `tdigest` dependency (not on CRAN) - replaced with base R
...
Version 0.5.0 represents a significant documentation milestone. The
package implements gene-based pathway enrichment with linkage-preserving
permutation nulls. All core statistical algorithms are frozen and
validated against the reference implementation.

The pkgdown site is available at:
<https://acad-uofa.github.io/PolyLinkR/>
